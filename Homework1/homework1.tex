...
\section{aus\_arrivals: compare arrivals from Japan, NZ, UK, US - JUST
FOR
FUN}\label{aus_arrivals-compare-arrivals-from-japan-nz-uk-us---just-for-fun}
...
\section{aus\_retail: sample a series and explore - JUST FOR
FUN}\label{aus_retail-sample-a-series-and-explore---just-for-fun}
...
\section{Match time plots to ACF plots - JUST FOR
FUN}\label{match-time-plots-to-acf-plots---just-for-fun}
...
\includegraphics[width=24.59in]{../../../../../../private/var/folders/z7/hslcs7d13097n9zmv9b992xr0000gn/T/RtmpzkKXXK/acfguess-1}
...
compare to white noise - JUST FOR
FUN}\label{aus_livestock-pigs-in-victoria-19901995-autoplot-acf-compare-to-white-noise---just-for-fun}
...
assess white noise - JUST FOR
FUN}\label{google-stock-daily-changes-re-indexing-differences-acf-assess-white-noise---just-for-fun}
